...
class UpdateStaffRecruitmentRequest extends FormRequest
{
    /**
    ...
    {
        // Route-level 'role' middleware already restricts who can reach this
        // action; only editable fields are validated below, so approval_status
        // and user_id can never be touched through this request.
        return true;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'date_of_recruitment' => 'required|date|after:today',
            'sourcing_method' => 'required|in:internal,external',
            'employment_basis' => 'required|in:Contract,Part-time,Fulltime',
