...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'qualifications_details.*.qualification' => 'nullable|string|max:255',
            'qualifications_details.*.institution' => 'nullable|string|max:255',
            'qualifications_details.*.year_obtained' => 'nullable|integer|min:1900|max:' . date('Y'),
