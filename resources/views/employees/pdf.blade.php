...
<body>
    ...
    <div class="app-header">Generated by {{ config('app.name') }}</div>
    ...
    <div class="header-section">
        <div class="profile-header">
            ...
            @if($employee->passport_photo)
                <img src="{{ public_path('storage/' . $employee->passport_photo) }}" 
                     class="profile-photo" 
                     alt="Passport Photo">
            @else
    ...
    <div class="app-footer">Generated by {{ config('app.name') }}</div>
</body>
</html>
