<div class="sidebar bg-primary border-start border-start-5 shadow rounded-start-5 border-dashed"
    ...
    <div class="d-md-flex flex-column p-0 pt-lg-3">
        <ul class="nav flex-column">
            @foreach ([['route' => 'dashboard', 'icon' => 'bi-bar-chart', 'label' => 'Dashboard'], ['route' => 'employees.index', 'icon' => 'bi-list-check', 'label' => 'Employees Management'], ['route' => 'events.index', 'icon' => 'bi-calendar-check', 'label' => 'Events Management'], ['route' => 'trainings.index', 'icon' => 'bi-book', 'label' => 'Trainings Management'], ['route' => 'appraisals.index', 'icon' => 'bi-search', 'label' => 'Appraisals Management'], ['route' => 'applications.index', 'icon' => 'bi-send', 'label' => 'Applications Management', ['route' => 'entries.index', 'icon' => 'bi-journal-text', 'label' => 'Applicants']], ['route' => 'attendances.index', 'icon' => 'bi-vector-pen', 'label' => 'Attendances Management'], ['route' => 'leaves.index', 'icon' => 'bi-bus-front', 'label' => 'Leave Management']] as $item)
                <li class="nav-item">
