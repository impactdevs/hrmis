<x-app-layout>
    ...
    <form action="{{ route('uncst-appraisals.update', ['uncst_appraisal' => $appraisal->appraisal_id]) }}" method="post"
        class="m-2" id="appraisalForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach ($options as $value => $text)
                                            <div class="form-check">
                                                <input type="radio" name="review_type" id="review_type_{{ $value }}"
                                                    value="{{ $value }}"
                                                    class="form-check-input @error('review_type') is-invalid @enderror" {{ $selected === $value ? 'checked' : '' }}>
                                ...
                                <div class="flex-wrap gap-4 d-flex">
                                    ...
                                    <select class="employees form-control" name="appraiser_id" id="appraiser_id"
                                        ...
                                        @foreach ($users as $user)
                                            <option value=""></option>
                                            <option value="{{ optional($user->employee)->employee_id }}" {{ $user->employee && $user->employee->employee_id == $appraisal->appraiser_id ? 'selected' : '' }}>
                                                {{ $user->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-lg-6">
                            <div class="p-3 rounded form-section bg-light">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <p> POSITION:
                                            {{ $employee ? optional($employee->position)->position_name : 'N/A' }}
                                        </p>
                                    </div>

                                    <div class="col-md-12">
                                        <p> DIVISION:
                                            {{ $employee ? optional($employee->department)->department_name : 'N/A' }}
                                        </p>
                                    </div>
                                    <div class="col-md-12">
                                        <p> DATE OF 1ST APPOINTMENT:
                                            {{ $employee && $employee->date_of_entry ? \Carbon\Carbon::parse($employee->date_of_entry)->toFormattedDateString() : 'N/A' }}
                                        </p>
                                    </div>
                                    <div class="col-md-12">
                                        <p> PROFESSIONAL QUALIFICATIONS:
                                            @if($employee && $employee->qualifications && $employee->qualifications->count() > 0)
                                                {{ $employee->qualifications->pluck('qualification')->join(', ') }}
                                            @else
                                                N/A
                                            @endif
                                        </p>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <!-- <div class="mt-4 col-12">
                                <p class="fw-bold">a. Other Qualifications</p>
                                <label for="job_compatibility" class="form-label">
                                   Outline any other qualifications achieved.
                                <div
                                    id="qualifications"
                                    class="form-control contenteditable"
                                    contenteditable="{{ $canAppraiseeEdit ? 'true' : 'false' }}"
                                    style="min-height: 100px; overflow-y: auto;"
                                    data-draft="{{ $staffDraftValue ? 'true' : 'false' }}"
                                    @if (!$canAppraiseeEdit) readonly @endif
                                        >{{ old('qualifications', $appraisal->qualifications ?? '') }}
                                </div>
                                    <input type="hidden" name="qualifications" id="qualifications" value="{{ old('qualifications', $appraisal->qualifications ?? '') }}">
                            </div> -->
                        ...
                        <div class="mt-4 col-12">
                            ...
                            <!-- <div class="mt-4 col-12">
                                ...
                                <label for="suggestions" class="form-label">
                                   Indicate the suggestions you think need to be addressed or attended to.
                                <div
                                    id="suggestions"
                                    class="form-control contenteditable"
                                    contenteditable="{{ $canAppraiseeEdit ? 'true' : 'false' }}"
                                    ...
                                    data-draft="{{ $staffDraftValue ? 'true' : 'false' }}"
                                    @if (!$canAppraiseeEdit) readonly @endif
                                        >{{ old('suggestions', $appraisal->suggestions ?? '') }}
                                </div>
                                    <input type="hidden" name="suggestions" id="suggestions" value="{{ old('suggestions', $appraisal->suggestions ?? '') }}">
                            </div> -->
                            ...
                            <table class="min-w-full text-base border border-gray-200" id="key-duties-table">
                                        ...
                                        <tr class="hover:bg-blue-50 transition-colors" data-row="{{ $i }}">
                                            ...
                                            <td class="px-6 py-2 border border-gray-200">
                                                <div class="editable-cell p-2 rounded {{ empty($plannedActivity) ? 'text-muted' : '' }}"
                                                    contenteditable="{{ $canAppraiseeEdit ? 'true' : 'false' }}"
                                                    data-placeholder="Enter task" oninput="updateHiddenInput(this)" @unless ($canAppraiseeEdit) data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Editing is disabled for your role"
                                                    onclick="bootstrap.Tooltip.getOrCreateInstance(this).show()" @endunless>
                                            ...
                                            <td class="px-6 py-2 border border-gray-200">
                                                <div class="editable-cell p-2 rounded {{ empty($outputResults) ? 'text-muted' : '' }}"
                                                    ...
                                                    @unless ($canAppraiseeEdit) data-bs-toggle="tooltip"
                                                        data-bs-placement="top" title="Editing is disabled for your role"
                                                    onclick="bootstrap.Tooltip.getOrCreateInstance(this).show()" @endunless>
                                            ...
                                            <td class="px-6 py-2 border border-gray-200">
                                                <div class="score-cell"
                                                    ...
                                                    onblur="validateNonZero(this)" @unless ($canAppraiseeEdit)
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Editing is disabled for your role"
                                                    onclick="bootstrap.Tooltip.getOrCreateInstance(this).show()" @endunless>
                                                    {{ $staffDraftValue ?: $superviseeScore }}
                                            ...
                                            <td class="px-6 py-2 border border-gray-200">
                                                <div class="score-cell"
                                                    contenteditable="{{ $canAppraisorEdit ? 'true' : 'false' }}"
                                                    data-type="score" oninput="updateScoreInput(this)"
                                                    onblur="validateNonZero(this)" @unless ($canAppraisorEdit)
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Editing is disabled for your role"
                                                    onclick="bootstrap.Tooltip.getOrCreateInstance(this).show()" @endunless>
                                                    {{ $headOfDivisionDraftValue ?: $supervisorScore }}
                                                </div>
                                                <input type="hidden"
                                            ...
                                            <td class="px-6 py-2 border border-gray-200">
                                                @if ($headOfDivisionDraftValue)
                                                    ...
                                                    --}}
                                                    <input type="number" class="form-control form-control-sm agreed-score-input"
                                                        min="0" max="6" step="0.5" value="" readonly>
                                                ...
                                                @else
                                                    <input type="number"
                                                        name="appraisal_period_rate[{{ $i - 1 }}][agreed_score]"
                                                        class="form-control form-control-sm agreed-score-input" min="0" max="6"
                                                        step="0.5" value="{{ $agreedScore }}" @if ($canAppraiseeEdit) readonly
                                                        @endif oninput="updateKeyDutiesOverall()"
                                                        onblur="validateNonZero(this)">
                                                @endif
                                            </td>
                                        ...
                                        <tr class="hover:bg-blue-50 transition-colors">
                                            <td class="px-6 py-2 border border-gray-200 bg-gray-50 italic text-gray-600"
                                                ...
                                                <div class="editable-cell p-2 rounded {{ empty($supervisorComment) ? 'text-muted' : '' }}"
                                                    ...
                                                    oninput="updateHiddenInput(this)" @unless ($appraisal->is_appraisor)
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Editing is disabled for your role"
                                                    onclick="bootstrap.Tooltip.getOrCreateInstance(this).show()" @endunless>
                                ...
                                <tfoot>
                                    <tr class="bg-blue-100 font-semibold">
                                        ...
                                        <td class="px-6 py-3 border border-gray-200 text-center" id="supervisee-total">
                                        </td>
                                        <td class="px-6 py-3 border border-gray-200 text-center" id="supervisor-total">
                                        </td>
                            ...
                            @push('scripts')
                                <script>
                                    $(function () {
                                            ...
                                            let newRow = `
                                                            <tr class="hover:bg-blue-50 transition-colors" data-row="new">
                                                                ...
                                                                <td class="px-6 py-2 border border-gray-200">
                                                                    ...
                                                                    <input type="hidden"
                                                                        name="appraisal_period_rate[new][supervisor_score]"
                                                                        value="0">
                                                                </td>
                                                                <td class="px-6 py-2 border border-gray-200">
                                                                    <input type="number"
                                        ...
                                        function validateNonZero(element) {
                                            let value = element.innerText.trim() || element.value?.trim() || "";
                                            let num = parseFloat(value);

                                            // Check if value is empty, not a number, or outside valid range (1-6)
                                            if (value === "" || isNaN(num) || num < 1 || num > 6) {
                                                alert("Score must be a number between 1 and 6.");
                                                if (element.contentEditable === "true") {
                                                    element.innerText = ""; // Clear the editable div
                                                } else {
                                                    element.value = ""; // Clear normal input
                                                }
                                                element.focus(); // Put cursor back
                                                return false;
                                            }
                                            return true;
                                        }
                                        ...
                                        function updateScoreInput(element) {
                                            let value = element.innerText.trim() || element.value?.trim() || "";
                                            let num = parseFloat(value);
                                            ...
                                            // Validate number
                                            if (value === "" || isNaN(num) || num < 1 || num > 6) {
                                                hiddenInput.value = ""; // Clear invalid value
                                                element.classList.add("text-danger"); // Highlight invalid
                                            } else {
                                                hiddenInput.value = num; // Sync valid value
                            ...
                            <tbody class="table-group-divider">
                                <tr class="table-primary">
                                    ...
                                    <td class="text-center"><input type="number"
                                            ...
                                            class="form-control form-control-sm score-input" min="0" @if ($staffDraftValue) style="color: transparent;" @endif
                                    ...
                                    <td class="text-center"><input type="number"
                                            ...
                                            @if ($headOfDivisionDraftValue) style="color: transparent;" @endif max="4">
                                    </td>
                                    <td class="text-center"><input type="number"
                                            ...
                                            @if ($headOfDivisionDraftValue) style="color: transparent;" @endif @if ($appraisal->is_appraisee) readonly @endif
                                            oninput="updatePersonalAttributesTotal()"
                                            onfocus="if(this.value=='0') this.value=''"
                                            onblur="if(this.value=='') this.value=0; updatePersonalAttributesTotal()"
                                            class="form-control form-control-sm score-input" min="0" max="4"></td>
                                </tr>
                                <tr class="table-primary">
                                    ...
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[commitment][appraisee_score]" @if (!$appraisal->is_appraisee) readonly @endif
                                            value="{{ $appraisal->personal_attributes_assessment['commitment']['appraisee_score'] ?? '' }}"
                                            class="form-control form-control-sm score-input" min="0" @if ($staffDraftValue) style="color: transparent;" @endif max="4" @if (!$appraisal->is_appraisee) readonly @endif>
                                    </td>
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[commitment][appraiser_score]" @if ($appraisal->is_appraisee) readonly @endif
                                            ...
                                            class="form-control form-control-sm score-input" min="0" max="4">
                                    </td>
                                    <td class="text-center">
                                        <input type="number"
                                ...
                                <tr class="table-primary">
                                    ...
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[team_work][appraisee_score]" @if (!$appraisal->is_appraisee) readonly @endif
                                            value="{{ $appraisal->personal_attributes_assessment['team_work']['appraisee_score'] ?? '' }}"
                                            class="form-control form-control-sm score-input" min="0" @if ($staffDraftValue) style="color: transparent;" @endif max="4">
                                    </td>
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[team_work][appraiser_score]" @if ($appraisal->is_appraisee) readonly @endif
                                ...
                                <tr class="table-primary">
                                    ...
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[productivity][appraisee_score]" @if (!$appraisal->is_appraisee) readonly @endif
                                            value="{{ $appraisal->personal_attributes_assessment['productivity']['appraisee_score'] ?? '' }}"
                                            class="form-control form-control-sm score-input" min="0" @if ($staffDraftValue) style="color: transparent;" @endif max="4">
                                    </td>
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[productivity][appraiser_score]" @if ($appraisal->is_appraisee) readonly @endif
                                ...
                                <tr class="table-primary">
                                    ...
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[integrity][appraisee_score]" @if (!$appraisal->is_appraisee) readonly @endif
                                            value="{{ $appraisal->personal_attributes_assessment['integrity']['appraisee_score'] ?? '' }}"
                                            class="form-control form-control-sm score-input" min="0" @if ($staffDraftValue) style="color: transparent;" @endif max="4">
                                    </td>
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[integrity][appraiser_score]" @if ($appraisal->is_appraisee) readonly @endif
                                ...
                                <tr class="table-primary">
                                    ...
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[flexibility][appraisee_score]" @if (!$appraisal->is_appraisee) readonly @endif
                                            value="{{ $appraisal->personal_attributes_assessment['flexibility']['appraisee_score'] ?? '' }}"
                                            class="form-control form-control-sm score-input" min="0" @if ($staffDraftValue) style="color: transparent;" @endif max="4">
                                    </td>
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[flexibility][appraiser_score]" @if ($appraisal->is_appraisee) readonly @endif
                                ...
                                <tr class="table-primary">
                                    ...
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[attendance][appraisee_score]" @if (!$appraisal->is_appraisee) readonly @endif
                                            value="{{ $appraisal->personal_attributes_assessment['attendance']['appraisee_score'] ?? '' }}"
                                            class="form-control form-control-sm score-input" min="0" @if ($staffDraftValue) style="color: transparent;" @endif max="4">
                                    </td>
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[attendance][appraiser_score]" @if ($appraisal->is_appraisee) readonly @endif
                                ...
                                <tr class="table-primary">
                                    ...
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[appearance][appraisee_score]" @if (!$appraisal->is_appraisee) readonly @endif
                                            value="{{ $appraisal->personal_attributes_assessment['appearance']['appraisee_score'] ?? '' }}"
                                            class="form-control form-control-sm score-input" min="0" @if ($staffDraftValue) style="color: transparent;" @endif max="4">
                                    </td>
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[appearance][appraiser_score]" @if ($appraisal->is_appraisee) readonly @endif
                                ...
                                <tr class="table-primary">
                                    ...
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[interpersonal][appraisee_score]" @if (!$appraisal->is_appraisee) readonly @endif
                                            value="{{ $appraisal->personal_attributes_assessment['interpersonal']['appraisee_score'] ?? '' }}"
                                            class="form-control form-control-sm score-input" min="0" @if ($staffDraftValue) style="color: transparent;" @endif max="4">
                                    </td>
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[interpersonal][appraiser_score]" @if ($appraisal->is_appraisee) readonly @endif
                                ...
                                <tr class="table-primary">
                                    ...
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[initiative][appraisee_score]" @if (!$appraisal->is_appraisee) readonly @endif
                                            value="{{ $appraisal->personal_attributes_assessment['initiative']['appraisee_score'] ?? '' }}"
                                            class="form-control form-control-sm score-input" min="0" @if ($staffDraftValue) style="color: transparent;" @endif max="4">
                                    </td>
                                    <td class="text-center">
                                        <input type="number"
                                            name="personal_attributes_assessment[initiative][appraiser_score]" @if ($appraisal->is_appraisee) readonly @endif
                                    ...
                                    @for ($j = 0; $j < $planningRows; $j++)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="performance_planning[{{ $j }}][description]"
                                                    value="{{ $keyOutput }}">
                                            </td>
                                            {{-- Performance Targets --}}
                                            <td>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-12">
                        <x-forms.text-area name="panel_recommendation" label="(b)	Recommendation of the Panel"
                            :isDraft="$executiveSecretaryDraftValue" id="panel_recommendation"
                            :value="old('panel_recommendation', $appraisal->panel_recommendation ?? '')"
                ...
                <div class="mb-3 row">
                    <div class="col-md-12">
                        <x-forms.text-area name="overall_assessment_and_comments"
                            :isDraft="$executiveSecretaryDraftValue"
            ...
            <div class="py-4 bg-white sticky-bottom border-top">
                <div class="container-lg">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        @endphp
                        @if (!isset($draft) || !$draft->is_submitted || $appraisal->is_draft)
    ...
    @push('scripts')
        <script>
            ...
            function updateKeyDutiesOverall() {
                ...
                // Count the actual number of agreed score inputs (this represents the actual rows with data)
                rowCount = agreedInputs.length;
                ...
                // Calculate the actual score out of 60 points (not percentage)
                const scaledAvg = maxScore > 0 ? (totalAgreed / maxScore) * 60 : 0;
            ...
            function updatePersonalAttributesTotal() {
                ...
                // There are 10 attributes, each with max 4 points = 40 max total
                // Calculate percentage based on the actual max (rowCount * 4)
                const scaledPercentage = agreedPct * 0.4; // 40% weight
                window.personalAttributesContribution = scaledPercentage;
                document.getElementById('overall-40pct').textContent = `${scaledPercentage.toFixed(1)}% (${totalAgreed}/${maxScore})`;
                updateTotalScore();
            }
            ...
            $(document).ready(function () {
                ...
                $('#appraisalForm').on('submit', function (e) {
                    ...
                    const sectionMap = {
                        ...
                        'suggestions': 'personal_details',
                        'qualifications': 'personal_details',
                    ...
                    function getSectionTextareaNames(sectionKey) {
                        const sectionSelectors = {
                            personal_details: '.form-section:has(textarea[name="if_no_job_compatibility"]), .form-section:has(textarea[name="unanticipated_constraints"]), .form-section:has(textarea[name="personal_initiatives"]), .form-section:has(textarea[name="training_support_needs"]), .form-section:has(textarea[name="suggestions"]), .form-section:has(textarea[name="qualifications"])',
    ...
    textarea {
        ...
        white-space: pre-wrap; /* preserves line breaks */
                    ...
                    $('#proceed-btn').on('click', function (event) {
                        event.preventDefault();
                        // Show the form again but keep it visible
                        $('.entire-form').removeClass('d-none');
                        // Remove the preview handler to prevent recursion
                        $('#appraisalForm').off('submit');
                        // Actually submit the form to the server
                        $('#appraisalForm')[0].submit();
                    });
                ...
                // Handle save-draft button - bypass preview entirely
                $(document).on('click', '#save-draft-btn', function (event) {
                    event.preventDefault();
                ...
                window.updateScoreInput = function (scoreCell) {
                    ...
                    const textContent = scoreCell.textContent.trim();

                    // If the content is empty or just whitespace, don't change anything
                    if (textContent === '') {
                        return;
                    }
                    ...
                    // If it's not a valid number, reset to empty and let user try again
                    ...
                    const clampedValue = Math.min(Math.max(parsedValue, 0), 6);

                    // Only update if the value actually changed (to avoid infinite loops)
                    if (clampedValue !== parsedValue) {
                        scoreCell.textContent = clampedValue;
                    }
                ...
                document.querySelectorAll('.score-cell').forEach(cell => {
                    ...
                    if (cell.getAttribute('contenteditable') === 'true') {
                        ...
                        cell.addEventListener('input', function () {
                            // Don't auto-update on every keystroke - let user finish typing
                            clearTimeout(this.updateTimer);
                            this.updateTimer = setTimeout(() => {
                                updateScoreInput(this);
                ...
                function initAppraisalApproval() {
                    console.log('Initializing approval handlers...');
                    let currentAppraisalId;

                    // Debug: Check if approve buttons exist
                    const approveButtons = $('.approve-btn');
                    const rejectButtons = $('.reject-btn');
                    console.log('Found approve buttons:', approveButtons.length);
                    console.log('Found reject buttons:', rejectButtons.length);

                    if (approveButtons.length === 0) {
                        console.warn('No approve buttons found! Check if buttons are rendered.');
                    }

                    approveButtons.click(function () {
                    ...
                    function approveAppraisal(appraisalId, status, reason = null) {
                        ...
                        // ✅ FIX: Capture all form data before approval
                        const formData = {};
                        ...
                        if ($form.length) {
                            ...
                            serializedArray.forEach(function (item) {
                                // Handle array fields (e.g., appraisal_period_rate[0][planned_activity])
                                const name = item.name;
                                const value = item.value;

                                if (name.includes('[')) {
                                    // Parse nested array notation
                        ...
                        $.ajax({
                            ...
                            beforeSend: function () {
                                ...
                                $('.approve-btn, .reject-btn').prop('disabled', true).text('Processing...');
                            },
                            ...
                            error: function (xhr, textStatus, errorThrown) {
                                ...
                                $('.approve-btn, .reject-btn').prop('disabled', false).text(function () {
                                    return $(this).hasClass('approve-btn') ? 'Approve' : 'Reject';
                                });
                                ...
                                if (xhr.responseJSON && xhr.responseJSON.message) {
                                    ...
                                    errorMessage = 'The appraisal could not be found';
                        ...
                        if (status === 'approved') {
                            ...
                            if (reason) {
                                $statusContainer.append(
                                    `<p class="mt-1"><strong>Rejection Reason:</strong> ${rejection_reason}</p>`);
                            }
                        }
                    }
                }
                ...
                function showToast(message) {
                    // Check if Toastify is available, otherwise use alert as fallback
    ...
    <div class="print-summary-cover d-none d-print-block" style="page-break-after: always;">
        ...
        <p><strong>Employee Name:</strong>
            {{ $employee ? ($employee->first_name . ' ' . $employee->last_name) : 'N/A' }}</p>
        <p><strong>Position:</strong> {{ $employee ? optional($employee->position)->position_name : 'N/A' }}</p>
        <p><strong>Division:</strong> {{ $employee ? optional($employee->department)->department_name : 'N/A' }}</p>
        <p><strong>Appraisal Period:</strong> {{ $appraisal->appraisal_start_date?->toDateString() }} -
            {{ $appraisal->appraisal_end_date?->toDateString() }}
        </p>
        <hr>
        <hr>
