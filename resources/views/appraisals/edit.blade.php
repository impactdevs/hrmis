    ...
    @if ($rejectedEntry)
        ...
        {{-- <script>
            window.addEventListener('DOMContentLoaded', (event) => {
                const toastEl = document.querySelector('.approval');
                if (toastEl) {
        ...
        <div class="mb-4 shadow card">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <div id="repeater-wrapper">
                            @foreach ($appraisal->appraisal_period_accomplishment as $appraisal_period_accomplishment)
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <x-forms.text-area
                                            name="appraisal_period_accomplishment[{{ $loop->index }}][planned_activity]" :isDisabled="!$appraisal->is_appraisee"
                                        ...
                                        <x-forms.text-area
                                            name="appraisal_period_accomplishment[{{ $loop->index }}][output_results]" :isDisabled="!$appraisal->is_appraisee"
                                        ...
                                        <x-forms.text-area
                                            name="appraisal_period_accomplishment[{{ $loop->index }}][remarks]" :isDisabled="!$appraisal->is_appraisee"
                            ...
                            <div class="mt-3">
                                <button type="button" class="btn btn-primary no-print" id="add-repeater">Add
                                    Activities</button>
                            </div>
                        ...
                        <div class="mt-4 col-12">
                            ...
                            <x-forms.text-area name="if_no_job_compatibility" :isDisabled="!$appraisal->is_appraisee" label="If No, explain:"
                                    ...
                                    <div class="mt-2 row g-3 repeater-rate-item">
                                        <div class="col-md-12">
                                            ...
                                            <x-forms.input
                                                ...
                                                :min="0" :max="5" placeholder="Supervisee Score"
                                                :value="old(
                                            ...
                                            <x-forms.input
                                                ...
                                                :min="0" :max="5" placeholder="Supervisor Score"
                                                :value="old(
            ...
            <fieldset class="p-2 mb-4 border">
                ...
                <div id="performance-planning-wrapper">
                    ...
                    <div class="mt-3">
                        <button type="button" class="btn btn-primary no-print" id="add-performance-row">Add
                            Plan</button>
                    </div>
                </div>
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                $('.score-input-component').on('input', function() {
                    let val = parseFloat($(this).val());
                    if (val > 5) $(this).val(5);
                    if (val < 0) $(this).val(0);
                });
        ...
        <div class="mt-2 row g-3 repeater-item">
            <div class="col-md-12">
                <x-forms.text-area name="appraisal_period_accomplishment[${repeaterIndex}][planned_activity]" :isDisabled="!$appraisal->is_appraisee"
                    id="appraisal_period_accomplishment[${repeaterIndex}][planned_activity]" :isDisabled="!$appraisal->is_appraisee"
        ...
        <div class="mt-2 row g-3 repeater-rate-item">
            <div class="col-md-12">
                <x-forms.text-area name="appraisal_period_rate[${rateRepeaterIndex}][planned_activity]" :isDisabled="!$appraisal->is_appraisee"
                ...
                <x-forms.input name="appraisal_period_rate[${rateRepeaterIndex}][supervisee_score]" :isDisabled="!$appraisal->is_appraisee"
                ...
                <x-forms.input name="appraisal_period_rate[${rateRepeaterIndex}][superviser_score]" :isDisabled="$appraisal->is_appraisee"
